...
export default function AdminDashboard({ onBack, onLogout, token }) {
  ...
  return (
    <div className="min-h-full bg-[#f3f8f5] text-gray-800 lg:flex">
      <aside className="hidden w-72 shrink-0 flex-col bg-emerald-950 px-5 py-6 text-white lg:flex">
        ...
        <div className="mt-10 border-b border-emerald-800 pb-6 text-center">
          ...
          <p className="mt-3 text-sm font-bold">ผู้ดูแลระบบ</p>
          <p className="mt-1 text-xs text-emerald-200">จัดการพื้นที่ IMPACT</p>
        </div>
        ...
        <nav className="mt-8 space-y-2 text-base font-bold">
          ...
          <a href="#overview" className="flex items-center gap-3 rounded-lg bg-emerald-700 px-3 py-3.5 text-white shadow-sm transition-colors hover:bg-emerald-600"><span className="flex h-8 w-8 items-center justify-center rounded-md bg-white/15 text-sm">▦</span> ภาพรวม</a>
          <a href="#dispatch" className="flex items-center gap-3 rounded-lg px-3 py-3.5 text-emerald-50 transition-colors hover:bg-emerald-900"><span className="flex h-8 w-8 items-center justify-center rounded-md bg-red-500/20 text-base">🚨</span> ศูนย์ประสานเหตุ</a>
          <a href="#traffic" className="flex items-center gap-3 rounded-lg px-3 py-3.5 text-emerald-50 transition-colors hover:bg-emerald-900"><span className="flex h-8 w-8 items-center justify-center rounded-md bg-amber-400/20 text-base">🚦</span> จัดการรถติด</a>
          <a href="#responders" className="flex items-center gap-3 rounded-lg px-3 py-3.5 text-emerald-50 transition-colors hover:bg-emerald-900"><span className="flex h-8 w-8 items-center justify-center rounded-md bg-sky-400/20 text-base">👥</span> ทีมช่วยเหลือ</a>
          <a href="#pins" className="flex items-center gap-3 rounded-lg px-3 py-3.5 text-emerald-50 transition-colors hover:bg-emerald-900"><span className="flex h-8 w-8 items-center justify-center rounded-md bg-green-400/20 text-base">📌</span> รายการหมุด</a>
        </nav>

        <button onClick={handleLogout} className="mt-auto flex items-center gap-3 rounded-lg px-3 py-3.5 text-left text-base font-bold text-emerald-100 transition-colors hover:bg-emerald-900">
      ...
      <div className="min-w-0 flex-1">
        ...
        <main className="p-4 sm:p-6 lg:p-8">
          <section id="overview" className="mb-6 flex flex-col gap-4 border-b border-emerald-100 pb-6 md:flex-row md:items-end md:justify-between">
            <div>
      ...
      <section id="dispatch" className="mb-8 overflow-hidden rounded-lg border border-red-200 bg-white shadow-sm">
      ...
      <section id="traffic" className="mb-8 overflow-hidden rounded-lg border border-orange-200 bg-white shadow-sm">
      ...
      <div id="responders"><ResponderPanel responders={responders} token={token} onChanged={fetchResponders} /></div>

      {/* Pins Table */}
      <div id="pins" className="overflow-hidden rounded-lg border border-emerald-100 bg-white shadow-sm">
